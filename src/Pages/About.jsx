...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gradient-to-b from-[#110e11] to-[#030009] px-6 py-10">
      <div className="container">
        <div className="lg:pl-[320px] lg:pr-[200px] lg:pt-20">
          ...
          <p className="text-gray-700 dark:text-white py-5">
            ...
            Mariano Marcos State University. I specialize in web design using
            React and Tailwind CSS to create modern user interfaces. My goal is
            to create impactful digital experiences that leave a positive impact
            on users.
          </p>
          ...
          <div className="grid gap-4  grid-cols-1 md:grid-cols-2">
            ...
            >
              <h1 className="text-slate-700  font-semibold dark:text-white">
                College
              </h1>
              <AboutMeItems
                image={logommsu}
