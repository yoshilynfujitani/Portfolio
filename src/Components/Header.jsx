...
const Header = () => {
  ...
  return (
    <motion.div className='container pt-16 px-6 py-5 text-black dark:text-slate-50 overflow-clip lg:pl-[320px] lg:pr-48 lg:pt-48' initial={{ y: -100 }} // Initial position off-screen
