...
const AboutMeItems = ({ image, Course, Year }) => {
  return (
    <>
      <div className="transition-all px-4 flex items-center min-h-[100px] py-1 gap-2  rounded-md hover:bg-lightModeSecondary dark:hover:bg-Main hover:cursor-pointer">
