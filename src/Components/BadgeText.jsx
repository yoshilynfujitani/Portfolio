...
const BadgeText = ({ props }) => {
  return (
    <button className='relative inline-flex  overflow-hidden rounded-md p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50'>
      ...
      <span className='inline-flex  cursor-pointer items-center justify-center rounded-md bg-slate-50 text-slate-950 dark:bg-slate-950 px-6 py-2 text-md font-medium dark:text-white backdrop-blur-3xl'>
        {props}
      </span>
    </button>
  )
