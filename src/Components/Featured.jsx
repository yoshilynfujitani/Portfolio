    ...
    <div className="bg-gray-100 flex flex-col justify-between dark:bg-gradient-to-b from-[#2c2c2e] via-[#231A29] to-[#100814] container rounded-md transition shadow-md hover:scale-105  lg:px-0">
      ...
      <div className="text-center pb-4">
        <a
          ...
          className="text-gray-900 dark:text-gray-200 transition-colors text-md md:text-lg text-transparent cursor-pointer flex items-center justify-center gap-1 hover:text-purple-100"
        >
          <span>
            <AiFillGithub />
          </span>
